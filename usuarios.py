...
def crear_usuarios(id_u, nombres, apellidos, telefono, direccion, tipo):
    ...
    if guardar_usuarios(usuarios):
        registrar_log(f"Usuario crado existosamente: {id_u} - {nombres} {apellidos}", "INFO")
